...
impl Tool for StatusTool {
    fn draw(&mut self, ui: &Ui, state: &mut GuiState) {
        ...
        status_flag!("Состояние ВУ (Ф)", "Команда TSF ", 6);
